...
|________ :file_folder: :heavy_minus_sign: **guards** : Diretório responsável por armazenar arquivos referentes a guarda de rotas

|________ :file_folder: :heavy_minus_sign: **helpers** : Diretório responsável por armazenar arquivos referentes a funcionalidades auxiliares
...
|________ :file_folder: :heavy_minus_sign: **components** : Diretório responsável por armazenar componentes comuns a aplicação
...
|________ :file_folder: :heavy_minus_sign: **styles** : Diretório responsável por armazenar arquivos referentes a estilos SCSS globais

|____ :file_folder: :heavy_minus_sign: **pages** : Diretório responsável por armazenar arquivos referentes as ferramentas e-Kaizen

|________ :file_folder: :heavy_minus_sign: **auth** : Diretório responsável por armazenar o componente de login
